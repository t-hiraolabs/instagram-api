# Meta アプリ審査（App Review）準備メモ — AImark
...
**日本語**
AImarkは、日本の小規模事業者（飲食店・美容室・バー・カフェなど）向けのInstagram運用支援アプリです。
AIがキャプションを作成し、フィード／ストーリー／リールの投稿・予約投稿・自動投稿を行い、
投稿の反応（フォロワー数・いいね・コメント・リーチ）を分析して表示します。

**English (審査は英語推奨)**
AImark helps small business owners in Japan (restaurants, salons, bars, cafés) manage their
