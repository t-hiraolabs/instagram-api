...
export const ACCOUNT_THEMES: AccountTheme[] = [
  ...
  },
  {
    ...
    accent: '#E0533B',
    captionStyle: 'band',
    toneHint: '活発でにぎやか。仲間とワイワイ・気軽に飲みに行きたくなる言葉。',
  },
  {
    key: 'night',
    label: 'ナイト（バー/ラウンジ等）',
    ...
    accent: '#9C6ADE',
    captionStyle: 'band',
    toneHint: '華やかで特別感。非日常・きらびやかな夜を演出する言葉。',
  },
  {
    key: 'nail',
    label: 'ネイル・まつ毛',
    ...
    accent: '#EC9BB6',
    captionStyle: 'pill',
    toneHint: 'かわいく丁寧。指先・目元が可愛くなるワクワク感のある言葉。',
  },
  {
    key: 'clinic',
    label: 'クリニック・整体',
    ...
    accent: '#2BB3A3',
    captionStyle: 'band',
    toneHint: '安心・誠実・清潔感。専門的すぎず分かりやすい説明の言葉。',
  },
  {
    key: 'school',
    label: '教室・スクール',
    ...
    accent: '#3F7AE0',
    captionStyle: 'pill',
    toneHint: '前向きで親しみやすい。学ぶ楽しさ・成長を後押しする言葉。',
  },
  {
    key: 'apparel',
    label: 'アパレル',
    ...
    accent: '#222222',
    captionStyle: 'band',
    toneHint: 'トレンド感とこだわり。コーデが欲しくなるスタイリッシュな言葉。',
  },
];
